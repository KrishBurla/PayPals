    ...
    <div className="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
      <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
        <div className="relative p-6 lg:p-8">
          ...
          <p className="mt-3 text-4xl font-extrabold tracking-tight text-teal-500">${totalOwed.toFixed(2)}</p>
        ...
        <div className="relative p-6 lg:p-8">
          ...
          <p className="mt-3 text-4xl font-extrabold tracking-tight text-rose-500">${totalOwe.toFixed(2)}</p>
        ...
        <div className="relative p-6 lg:p-8 bg-slate-50/50 flex flex-col justify-center">
          ...
          <p className={`mt-3 text-4xl font-extrabold tracking-tight ${net >= 0 ? 'text-teal-500' : 'text-rose-500'}`}>{`${net >= 0 ? '+' : '-'}$${Math.abs(net).toFixed(2)}`}</p>
